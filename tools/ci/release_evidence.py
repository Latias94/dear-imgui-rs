...
DEFAULT_EXPECTED_CELL_INVENTORY = (
    ...
    ExpectedCell(
        ...
        requirements=_requirements(
            artifacts=(
                *_RUNTIME_GATE_REQUIREMENTS,
                "runtime/runtime-environment.json",
                "runtime/viewport-sampler-objects-result.json",
                "runtime/viewport-texture-parameters-result.json",
            ),
            logs=(
                "runtime/display.stdout.log",
                "runtime/display.stderr.log",
                ...
                "runtime/viewport-sampler-objects.stdout.log",
                "runtime/viewport-sampler-objects.stderr.log",
                "runtime/viewport-texture-parameters.stdout.log",
                "runtime/viewport-texture-parameters.stderr.log",
            ),
        ),
    ),
    ExpectedCell(
    ...
    ExpectedCell(
        ...
        requirements=_requirements(
            ...
            logs=(
                "logs/binding-models.stdout.log",
                "logs/binding-models.stderr.log",
                "logs/source-provenance.stdout.log",
                ...
                "logs/binding-diff.stderr.log",
                "logs/msrv.stdout.log",
                "logs/msrv.stderr.log",
                "logs/core-tests.stdout.log",
                "logs/core-tests.stderr.log",
                "logs/core-docs.stdout.log",
                "logs/core-docs.stderr.log",
                "logs/packages.stdout.log",
                "logs/packages.stderr.log",
            ),
        ),
    ),
    ExpectedCell(
