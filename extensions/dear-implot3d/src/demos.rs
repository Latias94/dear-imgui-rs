...
impl Plot3DUi<'_> {
    ...
    pub fn show_all_demos(&self) {
        self.with_bound_context(|| unsafe { sys::ImPlot3D_ShowAllDemos() })
    }
    ...
    pub fn show_demo_window(&self) {
        self.with_bound_context(|| unsafe { sys::ImPlot3D_ShowDemoWindow(std::ptr::null_mut()) })
    }

    /// Show the main ImPlot3D demo window with a visibility flag.
    pub fn show_demo_window_with_flag(&self, p_open: &mut bool) {
        self.with_bound_context(|| unsafe { sys::ImPlot3D_ShowDemoWindow(p_open as *mut bool) })
    }
    ...
    pub fn show_style_editor(&self) {
        self.with_bound_context(|| unsafe { sys::ImPlot3D_ShowStyleEditor(std::ptr::null_mut()) })
    }
    ...
    pub fn show_metrics_window(&self) {
        self.with_bound_context(|| unsafe { sys::ImPlot3D_ShowMetricsWindow(std::ptr::null_mut()) })
    }
    ...
    pub fn show_metrics_window_with_flag(&self, p_open: &mut bool) {
        self.with_bound_context(|| unsafe { sys::ImPlot3D_ShowMetricsWindow(p_open as *mut bool) })
    }
}
