...
use crate::core::{
    ClickAction, DialogMode, FileDialogError, LayoutStyle, Selection, SortMode,
};
use crate::custom_pane::{CustomPane, CustomPaneCtx};
use crate::dialog_core::{
    ConfirmGate, CoreEvent, CoreEventOutcome, EntryId, ScanStatus,
};
use crate::dialog_state::FileDialogState;
use crate::dialog_state::{
    ClipboardOp, CustomPaneDock, FileClipboard, FileListColumnsConfig, FileListViewMode,
    PasteConflictAction, PasteConflictPrompt, PathBarStyle,
    PendingPasteJob,
};
...
mod tests {
    ...
    use super::{
        open_delete_modal_from_selection, open_rename_modal_from_selection,
        resolve_host_size_constraints,
    };
