// dear-imgui-rs-binding-provenance-v1 crate=dear-imgui-test-engine-sys target=native source=508a8fc8dacac2f346d353fed31b9bc90ed29adc spec=fnv1a64:ac6d75594abc5248 inputs=fnv1a64:ee50e00cead3a8b8 output=fnv1a64:7684e529f9943c0d
...
unsafe extern "C" {
    pub fn imgui_test_engine_post_swap(engine: *mut ImGuiTestEngine) -> ImGuiTestEngineStatus;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn imgui_test_engine_set_capture_enabled(
        engine: *mut ImGuiTestEngine,
        enabled: bool,
    ) -> ImGuiTestEngineStatus;
}
