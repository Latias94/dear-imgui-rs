// dear-imgui-rs-binding-provenance-v1 crate=dear-imgui-test-engine-sys target=native source=7be88e7fa267f251c7271a33d72b1aa5ca04a4cb spec=fnv1a64:ab89acf4a8f3067c inputs=fnv1a64:06fe21a38af88133 output=fnv1a64:1d5cc331b994ce51
...
unsafe extern "C" {
    pub fn imgui_test_engine_test_set_exception_injection(
        point: ImGuiTestEngineExceptionPoint,
    ) -> ImGuiTestEngineStatus;
}
unsafe extern "C" {
