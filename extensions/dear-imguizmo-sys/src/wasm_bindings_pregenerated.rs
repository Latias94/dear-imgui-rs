// dear-imgui-rs-binding-provenance-v1 crate=dear-imguizmo-sys target=wasm source=a90e95ad984c1653a65efd378dbf6da0e07d7ce8 spec=fnv1a64:08429533a3a58fa8 inputs=fnv1a64:5294ace2ca80cf3c output=fnv1a64:0434415909c21f4a
...
impl Default for ImGuiTableReconcileColumnData {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
pub type OPERATION = ::std::os::raw::c_uint;
...
pub type MOVETYPE = ::std::os::raw::c_uint;
...
#[link(wasm_import_module = "imgui-sys-v0")]
unsafe extern "C" {
    pub fn ImGuizmo_ComputeMouseRay(
        view: *const f32,
        projection: *const f32,
        mousePosition: ImVec2_c,
        rectPosition: ImVec2_c,
        rectSize: ImVec2_c,
        rayOrigin: *mut f32,
        rayDirection: *mut f32,
    );
}
#[link(wasm_import_module = "imgui-sys-v0")]
unsafe extern "C" {
