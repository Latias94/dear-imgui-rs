...
| ImGuiColorTextEdit | Syntax-aware editing, text diff, and autocomplete | Preview | [dear-imgui-cte](https://github.com/Latias94/dear-imgui-rs/tree/main/extensions/dear-imgui-cte) | [cimgui/cimCTE](https://github.com/cimgui/cimCTE) |
...
Key points:
- `*-sys` crates bind to C APIs (cimgui/cimplot/cimguizmo/cimCTE) with committed bindgen output by default.
...
- ImGuiColorTextEdit: `CTE_SYS_LIB_DIR`, `CTE_SYS_PREBUILT_URL`, `CTE_SYS_SKIP_CC`.
...
- ImGuiColorTextEdit details: `extensions/dear-imgui-cte-sys/README.md`.
...
- `cte_minimal` / `cte_showcase` -> `--features cte`
