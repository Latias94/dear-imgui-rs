...
- Releases now run the fixed same-commit gate, candidate-bound resumable 27-crate crates.io Trusted Publishing, exact prebuilt asset staging with checksums, and verified GitHub Release asset inventory through one protected workflow.
