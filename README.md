...
dear-imgui-wgpu = "0.15.0"   # or dear-imgui-glow / dear-imgui-ash
dear-imgui-winit = "0.15.0"  # or dear-imgui-sdl3
```
...
[dependencies]
dear-imgui-rs = "0.15.0"
dear-imgui-wgpu = { version = "0.15.0", default-features = false, features = ["wgpu-28"] }
dear-imgui-winit = "0.15.0"
```
...
[dependencies]
dear-imgui-rs = "0.15.0"
dear-imgui-wgpu = { version = "0.15.0", default-features = false, features = ["wgpu-27"] }
dear-imgui-winit = "0.15.0"
```
...
```toml
[dependencies]
dear-app = "0.15.0"  # Includes dear-imgui-rs, wgpu backend, and docking support
```
...
[dependencies]
dear-imgui-rs = "0.15.0"
dear-imgui-sys = { version = "0.15.0", features = ["backend-shim-android", "backend-shim-opengl3"] }
```
...
[dependencies]
# Plotting
dear-implot = "0.15.0"      # 2D plotting
dear-implot3d = "0.15.0"    # 3D plotting

# 3D Gizmos
dear-imguizmo = "0.15.0"         # Standard 3D gizmo + GraphEditor
dear-imguizmo-quat = "0.15.0"    # Quaternion-based gizmo

# Node Editor
dear-imnodes = "0.15.0"
dear-node-editor = "0.15.0"  # native-only imgui-node-editor integration

# Test automation
dear-imgui-test-engine = "0.15.0"

# File Browser
dear-file-browser = "0.15.0"  # Native dialogs + ImGui file browser

# Reflection-based UI helpers
dear-imgui-reflect = "0.15.0"
```
...
| dear-imgui-sys  | 0.15.0   | Binds Dear ImGui v1.92.8 (docking branch) |
...
|-----------|---------|------------------------|--------------------------------------------------|
| dear-app  | 0.15.0   | 0.15.0                 | App runner (docking, themes, add-ons)            |
...
| dear-node-editor    | 0.15.0   | 0.15.0                 | dear-node-editor-sys 0.15.0 | Native imgui-node-editor integration   |
| dear-imguizmo       | 0.15.0   | 0.15.0                 | dear-imguizmo-sys 0.15.0    | 3D gizmo + GraphEditor                 |
...
`dear-imgui-wgpu 0.15.0` with `default-features = false, features = ["wgpu-28"]` or
