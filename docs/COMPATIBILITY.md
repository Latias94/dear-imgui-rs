...
| dear-imgui-sys  | 0.7.x   | ImGui v1.92.5   | Docking branch via cimgui                 |
...
| Crate     | Version | External deps | Notes |
|-----------|---------|---------------|-------|
| dear-app  | 0.7.x   | winit, wgpu   | App runner (docking, themes, add-ons) |
...
| dear-imguizmo       | 0.7.x   | 0.7.x                  | dear-imguizmo-sys 0.7.x      | 3D gizmo                               |
