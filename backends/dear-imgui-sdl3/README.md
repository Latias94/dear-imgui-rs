...
```toml
dear-imgui-sdl3 = { version = "0.15.1", default-features = false }
```

Enable the official OpenGL3 renderer:

```toml
dear-imgui-sdl3 = { version = "0.15.1", features = ["opengl3-renderer"] }
```

Enable the official SDLRenderer3 renderer:

```toml
dear-imgui-sdl3 = { version = "0.15.1", features = ["sdlrenderer3-renderer"] }
```

Enable the official SDLGPU3 renderer:

```toml
dear-imgui-sdl3 = { version = "0.15.1", features = ["sdlgpu3-renderer"] }
```
