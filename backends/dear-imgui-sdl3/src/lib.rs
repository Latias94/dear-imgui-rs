...
pub use self::viewport::{
    enable_native_ime_ui, init_for_d3d, init_for_metal, init_for_other, init_for_platform_sdl_gpu,
...
#[cfg(feature = "sdlgpu3-renderer")]
pub use self::viewport::{init_for_sdl_gpu};
#[cfg(feature = "sdlgpu3-renderer")]
use self::core::{new_frame_gpu3_impl, shutdown_gpu_impl, init_sdlgpu3_impl};
