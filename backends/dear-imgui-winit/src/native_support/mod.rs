...
//!
//! [`collect_monitor_snapshots`] enumerates monitors from the supplied
...
//! they do not retain live Winit monitor handles. X11 work-area data is kept as
//! desktop-scoped evidence and therefore currently falls back to the full
//! monitor rectangle.
...
pub use monitors::{
    MonitorCollectionError, MonitorIdentity, MonitorSnapshot, WorkAreaFallback, WorkAreaProvenance,
