...
pub(super) fn extent_from_size_and_scale(
    size: [f32; 2],
...
pub(super) fn extent_from_viewport(vpm: &Viewport) -> vk::Extent2D {
    extent_from_size_and_scale(vpm.size(), vpm.framebuffer_scale())
}

pub(super) fn extent_from_imvec2(size: sys::ImVec2, framebuffer_scale: [f32; 2]) -> vk::Extent2D {
