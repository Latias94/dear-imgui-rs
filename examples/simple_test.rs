...
use wgpu::{
    Backends, Color as WgpuColor, CommandEncoderDescriptor,
    Device, DeviceDescriptor, Features, Instance, InstanceDescriptor, Limits, LoadOp,
...
impl ApplicationHandler for SimpleApp {
    fn resumed(&mut self, event_loop: &ActiveEventLoop) {
        ...
        platform.attach_window(self.window.as_ref().unwrap(), dear_imgui_winit::HiDpiMode::Default, &mut imgui_ctx);
