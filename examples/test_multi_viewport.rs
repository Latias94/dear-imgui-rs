//! Multi-Viewport Test Example with WGPU
//!
//! This example demonstrates multi-viewport functionality using dear-imgui with winit and wgpu.
//! It creates a window with ImGui demo and allows windows to be detached into separate OS windows.
...
impl AppWindow {
    fn setup_gpu(event_loop: &ActiveEventLoop) -> Self {
        ...
        let window = {
            ...
            let attributes = Window::default_attributes()
                ...
                .with_title(format!("Dear ImGui Multi-Viewport Test - WGPU {version}"));
    ...
    fn setup_imgui(&mut self, event_loop: &ActiveEventLoop) {
        ...
        // TODO: Set up renderer backend for multi-viewport
        // Currently WgpuRenderer doesn't implement RendererViewportBackend
        // #[cfg(feature = "multi-viewport")]
        // {
        //     context.set_renderer_backend(Box::new(renderer));
        // }
...
fn main() {
    env_logger::init();
    println!("Starting Dear ImGui Multi-Viewport Test...");

    #[cfg(feature = "multi-viewport")]
    println!("Multi-viewport feature is enabled at compile time");

    #[cfg(not(feature = "multi-viewport"))]
    println!("Multi-viewport feature is NOT enabled at compile time");
